...
# Configuración para que funcione bien en Windows (me costó descubrir esto)
os.environ['PYTHONIOENCODING'] = 'utf-8'
sys.stdout = io.TextIOWrapper(sys.stdout.buffer, encoding='utf-8', errors='replace')
sys.stderr = io.TextIOWrapper(sys.stderr.buffer, encoding='utf-8', errors='replace')

# Oculto las advertencias molestas que me distraían
...
# Primero verifico que el archivo exista (aprendí esto por las malas)
...
try:
    pipeline_diarizacion = DiarizationPipeline(use_auth_token="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")
